...
WebUI.click(findTestObject('Preparaciones/Ambiente TEST/Item_Categoria'))
...
WebUI.waitForElementPresent(findTestObject('Preparaciones/Marca Requisito 2'), 10)

WebUI.waitForElementVisible(findTestObject('Preparaciones/Marca Requisito 2'), 10)

WebUI.click(findTestObject('Preparaciones/Marca Requisito 2'))

// click casilla para marcar requisito
WebUI.waitForElementPresent(findTestObject('Preparaciones/Marca Requisito 3'), 10)

WebUI.waitForElementVisible(findTestObject('Preparaciones/Marca Requisito 3'), 10)

WebUI.click(findTestObject('Preparaciones/Marca Requisito 3'))

// click casilla para marcar requisito
WebUI.waitForElementPresent(findTestObject('Preparaciones/Marca Requisito 4'), 10)

WebUI.waitForElementVisible(findTestObject('Preparaciones/Marca Requisito 4'), 10)

WebUI.click(findTestObject('Preparaciones/Marca Requisito 4'))

// click casilla para marcar requisito
WebUI.waitForElementPresent(findTestObject('Preparaciones/Marca Requisito 6'), 10)

WebUI.waitForElementVisible(findTestObject('Preparaciones/Marca Requisito 6'), 10)

WebUI.click(findTestObject('Preparaciones/Marca Requisito 6'))
