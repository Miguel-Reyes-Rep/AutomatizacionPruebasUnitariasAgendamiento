...
// Generar un término médico aleatorio
def terminosMedicos4 = ['Resolución espacial', 'Contraste', 'Resolución temporal', 'Artefactos', 'Ruido', 'Profundidad de campo'
	, 'Dosis de radiación', 'Tiempo de adquisición', 'Interpretación clínica', 'Formato de imagen']

// Seleccionar un término aleatorio
Random random4 = new Random()

def terminoAleatorio4 = terminosMedicos4[random4.nextInt(terminosMedicos4.size())]

// Escribir el término aleatorio en el campo de texto con el ID 'inputBaseelementName'
WebUI.setText(findTestObject('Elementos/inputBaseelementName'), terminoAleatorio4)
...
def terminoAleatorio5 = terminosObser[random5.nextInt(terminosObser.size())]

// Escribir el término aleatorio en el campo de texto con el ID 'inputBaseobservationsundefined'
WebUI.setText(findTestObject('Elementos/inputBaseobservationsundefined'), terminoAleatorio5)
